$$ \Huge\textsf{\color{red}Q\color{orangered}u\color{orange}e\color{green}e\color{blueviolet}r\color{violet}T\color{darkred}e\color{chocolate}a\color{deepskyblue}r\color{lightgray}M\color{magenta}C } $$
